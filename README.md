...
The most convenient way for getting your new project from GitHub is the <kbd>Get from VCS</kbd> action available on the
...
The next step, after opening your project in IntelliJ IDEA, is to set the proper <kbd>SDK</kbd> to Java in version `17`
