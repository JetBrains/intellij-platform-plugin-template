...
| `javaVersion`               | Java language level used to compile sources and to generate the files for - Java 11 is required since 2020.3. |
| `gradleVersion`             | Version of the Gradle used for plugin development.                                                            |
